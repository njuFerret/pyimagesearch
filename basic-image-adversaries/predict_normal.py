...
print("[INFO] Loading pre-trained RestNet50 model...")
model = ResNet50(weights="imagenet")

# Make predictions on the input and parse the top-3 predictions
...
for (i, (imagenetID, label, prob)) in enumerate(predictions):
    ...
    # (This label will be needed for the next script which will perform the actual adversarial attack)
    if i == 0:
